...
def test_import_experiment_configs():
    ...
    import experiments.kuhn_poker.dream_network_capacity_extremes_ablation.config  # noqa: F401
    import experiments.kuhn_poker.dream_network_depth_ablation.config  # noqa: F401
